...
# "Methylation_methyl450", "CNVSNP", "miRNASeqGene"
brca <- suppressMessages(curatedTCGAData("BRCA", c("RNASeq2GeneNorm"), version = "2.0.1", dry.run = FALSE))
...
# code used to interpret the above information
